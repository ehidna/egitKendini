...
--
-- Host: localhost:8889
-- Generation Time: May 12, 2015 at 12:34 PM
...
CREATE TABLE `uyeler` (
  ...
  `meslekID` int(30) NOT NULL,
  `dTarihi` date NOT NULL,
  `telNo` varchar(10) NOT NULL,
  `adres` tinytext NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7123830 DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `uyeler`
  MODIFY `uyeID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7123830;
